...
sections:
  ...
  - block: markdown
    content:
      ...
      subtitle: ''
      text: |-
        <span style="font-weight: bold;">2025.01</span>: Our paper "<span style="color: blue;">KNN-MMD: Cross Domain Wireless Sensing via Local Distribution Alignment</span>" has been submitted for possible publication.<br> 
        <span style="font-weight: bold;">2025.01</span>: Our paper "<span style="color: blue;">Discriminatory Order Assignment and Payment-Setting of On-Demand Food-Delivery Platforms: A Multi-Action and Multi-Agent Reinforcement Learning Framework</span>" and a conference version "<span style="color: blue;">How Food-Delivery Platforms Discriminate Couriers: A Multi-Action and Multi-Agent Reinforcement Learning Method for Order Assignment and Payment Setting</span>" have been submitted for possible publication.<br> 
