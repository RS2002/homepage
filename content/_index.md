...
sections:
  ...
  - block: markdown
    content:
      ...
      subtitle: ''
      text: |-
#        <span style="font-weight: bold;">2025.02</span>: Our paper "<span style="color: blue;">CSI-BERT2: A BERT-Inspired Framework for Efficient CSI Prediction and Recognition in Wireless Communication and Sensing</span>" (extended version of "<span style="color: blue;">Finding the Missing Data: A BERT-inspired Approach Against Package Loss in Wireless Sensing</span>" in <a href="https://infocom2024.ieee-infocom.org/">IEEE INFOCOM DeepWireless Worshop 2024</a>) has been submitted for possible publication.<br> 
