...
sections:
  ...
  - block: features
    content:
      ...
      items:
        - name: Code
          description: "<div style='text-align: left'>Proficient in: C/C++ (CCF-CSP:320, Top 0.8%), Python, Matlab, Pytorch<br>Familiar with: Java, MySQL, Git, Linux, TensorFlow<br>Knowledgeable in: Assembly, Verilog, Web Scraping, Flask, QT, Docker, Raspberry Pi, ESP32"
          icon: code
          icon_pack: fas
        - name: Music
